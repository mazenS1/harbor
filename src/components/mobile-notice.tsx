    ...
    <div className="flex min-h-dvh flex-col items-center justify-center gap-7 bg-canvas px-8 text-center">
      ...
      <div className="flex max-w-md flex-col gap-3.5">
        ...
        <p className="text-[14.5px] leading-relaxed text-ink-muted">
          This instance of Harbor is made for desktop. Our standalone iOS and Android apps are
          coming soon, each with a bespoke, mobile-first experience built for its native platform.
        </p>
        <p className="text-[14.5px] leading-relaxed text-ink-muted">
