...
function AbLoopChip({ ab, visible }: { ab: AbLoopState; visible: boolean }) {
  return (
    <div
      className={`pointer-events-none absolute left-7 top-24 z-30 transition-all duration-200 ease-out ${
...
function FrameToast({ toast }: { toast: FrameGrabToast }) {
  return (
    ...
    >
      <div
        className={`pointer-events-auto flex items-center gap-2.5 rounded-full border py-2 pl-4 pr-2 text-[12.5px] font-medium backdrop-blur-md ${
          toast.kind === "ok"
